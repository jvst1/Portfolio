...
namespace Portfolio.Data.Security
{
    public class IdentityClaimsProfileService : IProfileService
    {
        ...
        public async Task GetProfileDataAsync(ProfileDataRequestContext context)
        {
            ...
            //claims.Add(new Claim(ClaimTypes.Role, Roles.Consumer)); // need this for role-based authorization - https://stackoverflow.com/questions/40844357/role-based-authorization-with-identityserver4
